...
ansible-playbook -i cloud3b_inventory.yml ../../cloud_automation/buildcloud.yml -e cloud_dir=${cloud_dir} -e @cloud3b.yml -e @passwords.yml --ask-vault-pass --skip-tags 3par,ceph $@
