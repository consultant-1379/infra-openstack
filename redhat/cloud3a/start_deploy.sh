...
ansible-playbook -i cloud3a_inventory.yml ../../cloud_automation/buildcloud.yml -e cloud_dir=${cloud_dir} -e @cloud3a.yml -e @passwords.yml --ask-vault-pass --skip-tags 3par,ceph $@
