...
ansible-playbook -i cloudenv4_inventory.yml ../../cloud_automation/buildcloud.yml -e cloud_dir=${cloud_dir} -e @cloudenv4-flexos.yml -e @passwords-flexos.yml --ask-vault-pass --skip-tags vnx,unity,3par,ceph $@
