...
ansible-playbook -i cloud16b_inventory.yml ../../cloud_automation/buildcloud.yml -e cloud_dir=${cloud_dir} -e @cloud16b.yml -e @passwords.yml -e rhsm_user=$rhsm_user -e rhsm_password=$password_rhsm --ask-vault-pass --skip-tags vnx,unity,3par,ceph $@
