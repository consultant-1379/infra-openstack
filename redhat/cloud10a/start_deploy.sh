...
# added flexos to the skip list and also removed unity from skip list as unity role required in vnx setup 
ansible-playbook -i cloud10a_inventory.yml ../../cloud_automation/buildcloud.yml -e cloud_dir=${cloud_dir} -e @cloud10a.yml -e @passwords.yml -e rhsm_user=$rhsm_user -e rhsm_password=$password_rhsm --ask-vault-pass --skip-tags flexos,3par,ceph,$@
